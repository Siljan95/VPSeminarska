...
#### Метод за генерирање на мапата – GenerateMap()
   ![GenerateMap](http://s32.postimg.org/6dghikxrp/Untitled3.png)
         ...
         нова игра. Податоците за блоковите се чуваат во Dictionary од Tiles каде како key чува
         ...
         Доколку не влезе зе креира рандом некршлив блок или празен блок и се додава во мапата.
